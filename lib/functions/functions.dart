...
//base url
String url = 'https://tagxi-server.ondemandappz.com/'; // please add '/' at the end of the url as 'https://yourwebsite.com/'
String mapkey = 'AIzaSyDFEHUTuhj3uQc2aO_EYcuP3zo_qUolfn4';
